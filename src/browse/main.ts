import { Block, Blockchain } from "../lib/transaction.js";
// Press Windows + . to open emoji dialog
enum Status {
...
(async function main(): Promise<void> {
  ...
  function addTransaction() {
    ...
    pendingTransactionsEl.textContent = blockchain.pendingTransaction.map(t =>
